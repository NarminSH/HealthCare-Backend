...
from doctors.api.views import (DoctorsAPIView, DoctorAPIView, DoctorAppointmentsAPIView, AppointmentsAPIView )
...
urlpatterns = [
    ...
    path('appointments/', AppointmentsAPIView.as_view(), name='create_appointment')
]